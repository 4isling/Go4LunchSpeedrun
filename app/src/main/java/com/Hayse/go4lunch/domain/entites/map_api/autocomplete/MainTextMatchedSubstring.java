...
public class MainTextMatchedSubstring implements Serializable
{
    ...
    @Expose
    private Long offset;
    private final static long serialVersionUID = 2427447291349169855L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MainTextMatchedSubstring) == false) {
            return false;
        }
        MainTextMatchedSubstring rhs = ((MainTextMatchedSubstring) other);
